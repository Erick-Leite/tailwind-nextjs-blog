    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700 md:mt-10 md:divide-y-0">
        <div className="space-y-2 pb-8 pt-6 md:space-y-0 md:rounded-md md:border-2 md:border-gray-200 md:border-opacity-60 md:p-0 md:dark:border-gray-700">
          <h1 className="text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:border-b-2 md:border-gray-200 md:border-opacity-60 md:p-[1.5rem] md:text-5xl md:leading-12 md:dark:border-gray-700">
            Latest
          </h1>
        ...
        <ul className="divide-y divide-gray-200 dark:divide-gray-700 md:divide-y-0">
          ...
          {displayPosts.map((post) => {
            ...
            return (
              <li key={path} className="py-12 md:mt-12 md:py-0">
                <article className="grid md:overflow-hidden md:rounded-md md:border-2 md:border-gray-200 md:border-opacity-60 md:dark:border-gray-700 xl:grid-cols-4">
                  ...
                  <div className="mt-6 text-base font-medium leading-6 md:col-start-1 md:col-end-4 md:row-start-4 md:mt-0 md:border-t-2 md:border-gray-200 md:border-opacity-60 md:dark:border-gray-700 xl:col-start-2 xl:col-end-5">
                    <Link
                      href={`/blog/${slug}`}
                      className="flex text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 md:items-center md:justify-center md:p-[0.75rem] md:hover:bg-primary-500 md:hover:text-primary-100 md:dark:hover:text-primary-950"
      ...
      <div className="grid md:mt-10 md:grid-cols-2 md:items-center xl:grid-cols-3">
        <div className="hidden md:col-start-1 md:col-end-2 md:block">
          {pagination && pagination.totalPages && (
            <Pagination currentPage={pagination.currentPage} totalPages={pagination.totalPages} />
          )}
        </div>
        {posts.length > initialDisplayPosts.length && (
          <div className="flex justify-end text-base font-medium leading-6 md:col-start-2 md:col-end-3 xl:col-start-3 xl:col-end-4">
            <Link
              href="/blog"
